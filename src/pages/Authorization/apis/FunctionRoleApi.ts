...
export async function getAllFunction(): Promise<ApiResponse> {
...
export async function fetchAllFunctionRole(): Promise<ApiResponse> {
    const apiUrl = import.meta.env.VITE_API_BASE_URL + '/function/role/all';
...
export async function updateFunctionRole(body: any): Promise<ApiResponse> {
    const apiUrl = import.meta.env.VITE_API_BASE_URL + '/function/role/update';
...
export async function addFunctionRole(body: any): Promise<ApiResponse> {
    const apiUrl = import.meta.env.VITE_API_BASE_URL + '/function/role/add';
